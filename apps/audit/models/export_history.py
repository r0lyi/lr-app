...
class ExportHistory(CreatedAtModel):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete = models.SET_NULL, null = True, related_name = 'export_histories')
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields = [
                'export_type',
                'created_at'], name = 'export_type_created_idx')]
