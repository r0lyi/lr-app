...
class VacationRequestViewTests(VacationBaseTestCase):
    ...
    def test_employee_can_open_request_page(self):
        ...
        self.assertContains(response, "data-range-calendar")
        self.assertContains(response, "data-start-input-id=")
        self.assertContains(response, "data-end-input-id=")
        self.assertNotContains(response, 'data-calendar-role="start"')
        self.assertNotContains(response, 'data-calendar-role="end"')
